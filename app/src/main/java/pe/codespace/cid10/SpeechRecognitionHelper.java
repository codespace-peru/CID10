...
class SpeechRecognitionHelper {
	...
	private static void startRecognitionActivity(Activity ownerActivity) {		
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Você pode falar agora...");
	...
	private static void installGoogleVoiceSearch(final Activity ownerActivity) {
		Dialog dialog = new AlertDialog.Builder(ownerActivity)
			.setMessage("Para usar o reconhecimento de voz, você precisa instalar \"Google Voice Search\"")
			.setTitle("Você deseja instalar Voice Search a partir Google Play?")
