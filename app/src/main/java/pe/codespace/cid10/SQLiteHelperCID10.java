 ...
 */
public class SQLiteHelperCID10 extends SQLiteOpenHelper {
    private final Context myContext;
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "cid10.db";
    private static final String DATABASE_PATH = "databases/";
    private static File DATABASE_FILE = null;
    private boolean mInvalidDatabaseFile = false;
    private boolean mIsUpgraded  = false;
    private int mOpenConnections=0;
    private static SQLiteHelperCID10 mInstance;

    public synchronized static SQLiteHelperCID10 getInstance (Context context){
        if(mInstance == null){
            mInstance = new SQLiteHelperCID10(context.getApplicationContext());
        }
        return mInstance;
    }

    private SQLiteHelperCID10(Context context)  {
   ...
   public boolean eliminarFavorito(String codCat){
    ...
    public String[][] searchTexto(String cadena) {
        SQLiteDatabase db = null;
        Cursor cursor=null, cursor1=null;
        String sqlLike = "SELECT numCapitulo, numGrupo, codCategoria, nombreCategoria FROM categorias WHERE (nombreCategoria LIKE '%" + cadena  + "%' OR codCategoria LIKE '%" + cadena  + "%')";
        try{
            db = getReadableDatabase();
