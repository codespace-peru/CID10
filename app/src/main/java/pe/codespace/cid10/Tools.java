...
public class Tools {
    ...
    public static void ShareApp(Context context){
        Social.share(context, context.getResources().getString(R.string.action_share), context.getResources().getString(R.string.share_description) + " " + Uri.parse("https://play.google.com/store/apps/details?id=pe.codespace.cid10"));
    }
